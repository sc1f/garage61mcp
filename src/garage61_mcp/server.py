...
from .tools import (
    ...
    list_cars,
    list_tracks,
    FASTEST_LAP_TELEMETRY_TOOL,
    USER_FASTEST_LAP_TOOL,
    OVERALL_FASTEST_LAP_TOOL,
    LIST_CARS_TOOL,
    LIST_TRACKS_TOOL
)
...
async def main():
    ...
    async def call_tool(name: str, arguments: dict) -> list[TextContent]:
        ...
        try:
            if name == "list_cars":
            ...
            elif name in ["get_fastest_lap_telemetry", "get_user_fastest_lap", "get_overall_fastest_lap"]:
                ...
                if name == "get_fastest_lap_telemetry":
                    logger.debug("Calling get_fastest_lap_telemetry")
                    return await get_fastest_lap_telemetry(car, track)
                elif name == "get_user_fastest_lap":
                    logger.debug("Calling get_user_fastest_lap")
                    return await get_user_fastest_lap(car, track)
                elif name == "get_overall_fastest_lap":
                    logger.debug("Calling get_overall_fastest_lap")
                    return await get_overall_fastest_lap(car, track)
            else:
